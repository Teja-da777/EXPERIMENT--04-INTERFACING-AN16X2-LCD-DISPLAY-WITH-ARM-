...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "THEJESWARAN M");
  HAL_Delay(500);
  Lcd_cursor(&lcd, 1,1);
  Lcd_string(&lcd, "212223240168");
  HAL_Delay(500);
  while (1)
  {
  }
...
<img width="1024" height="535" alt="image" src="https://github.com/user-attachments/assets/c355eb37-e440-4b65-ba94-a2e593bdfb6a" />
